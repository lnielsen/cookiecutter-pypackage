...
copyright = u'{{ cookiecutter.year }}, {{ cookiecutter.copyright_holder }}'
...
html_theme_options = {
    ...
    'extra_nav_links' : {
        '{{ cookiecutter.repo_name }}@GitHub' : 'http://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.repo_name }}/',
        '{{ cookiecutter.repo_name }}@PyPI' : 'http://pypi.python.org/pypi/{{ cookiecutter.repo_name }}/',
    }
}
